...
var I18n = function (_Component) {
  ...
  function I18n(props, context) {
    ...
    _this.options = _extends$1({}, getDefaults(), i18nOptions, props);
...
function translate(namespaceArg) {
  ...
  return function Wrapper(WrappedComponent) {
    var Translate = function (_Component) {
      _inherits$1(Translate, _Component);

      function Translate(props, context) {
        _classCallCheck$1(this, Translate);

        var _this = _possibleConstructorReturn$1(this, (Translate.__proto__ || Object.getPrototypeOf(Translate)).call(this, props, context));
        ...
        var i18nOptions = _this.i18n && _this.i18n.options && _this.i18n.options.react || {};
        _this.options = _extends$2({}, getDefaults(), i18nOptions, options);
      ...
      _createClass$1(Translate, [{
        ...
        value: function render() {
          ...
          return react.createElement(I18n, _extends$2({ ns: this.namespaces }, this.options, this.props, { i18n: this.i18n }), function (t, _ref) {
...
var Interpolate = function (_Component) {
  ...
  _createClass$2(Interpolate, [{
    ...
    value: function render() {
      ...
      var tOpts = _extends$3({}, this.props.options, { interpolation: { prefix: '#$?', suffix: '?$#' } });
    ...
    return astNodes.reduce(function (mem, node, i) {
      if (node.type === 'tag') {
        ...
        if (typeof child === 'string') {
          ...
          mem.push(react.cloneElement(child, _extends$4({}, child.props, { key: i }), inner));
...
var Trans = function (_React$Component) {
  ...
  _createClass$3(Trans, [{
    key: 'render',
    value: function render() {
      var contextAndProps = _extends$4({ i18n: this.context.i18n, t: this.context.t }, this.props);
      ...
      var children = contextAndProps.children,
          ...
          additionalProps = _objectWithoutProperties$1(contextAndProps, ['children', 'count', 'parent', 'i18nKey', 'tOptions', 'ns', 'i18n', 't']);
      ...
      var translation = key ? t(key, _extends$4({}, tOptions, { interpolation: { prefix: '#$?', suffix: '?$#' }, defaultValue: defaultValue, count: count, ns: namespace })) : defaultValue;
...
var resolver = function (wretcher) {
    ...
    var finalOpts = mix(config.defaults, opts);
    ...
    var req = middlewareHelper(middlewares)(config.polyfill("fetch"))(url, finalOpts);
    var wrapper = req.then(function (response) {
        if (!response.ok) {
            return response[config.errorType || "text"]().then(function (_) {
                var err = new Error(_);
                err[config.errorType] = _;
...
var Wretcher = /** @class */ (function () {
    ...
    Wretcher.prototype.defaults = function (opts, mixin) {
        ...
        config.defaults = mixin ? mix(config.defaults, opts) : opts;
        return this;
    };
    /**
    ...
    Wretcher.prototype.polyfills = function (polyfills) {
        config.polyfills = __assign$1({}, config.polyfills, polyfills);
        return this;
    };
    /**
    ...
    Wretcher.prototype.signal = function (controller) {
        return this.selfFactory({ options: __assign$1({}, this._options, { signal: controller.signal }) });
    };
    /**
    ...
    Wretcher.prototype.method = function (method, opts) {
        return resolver(this.options(__assign$1({}, opts, { method: method })));
    };
    /**
    ...
    Wretcher.prototype.body = function (contents) {
        return this.selfFactory({ options: __assign$1({}, this._options, { body: contents }) });
    };
    /**
...
var convertFormData = function (formObject) {
    var formData = config.polyfill("FormData", { instance: true });
...
let Home = (_dec = translate(['commons', 'index']), _dec(_class = (_temp = _class2 = class Home extends react.Component {
    ...
    constructor(props) {
        ...
        this.login = () => {
            ...
            factory(loginUrl).options({ credentials: 'same-origin' }).formUrl(loginForm).post().error(400, () => {
    ...
    render() {
        ...
        return react.createElement(
            'form',
            { id: 'login', action: '/login', method: 'POST', noValidate: true, onSubmit: this.handleSubmit },
            react.createElement('img', { src: 'http://via.placeholder.com/260x390', width: '260', height: '390', alt: '' }),
...
var Logger = function () {
  ...
  Logger.prototype.create = function create(moduleName) {
    return new Logger(this.logger, _extends$5({ prefix: this.prefix + ':' + moduleName + ':' }, this.options));
  };
...
var ResourceStore = function (_EventEmitter) {
  ...
  ResourceStore.prototype.addResourceBundle = function addResourceBundle(lng, ns, resources, deep, overwrite) {
    ...
    if (deep) {
      ...
      pack = _extends$6({}, pack, resources);
    }
  ...
  ResourceStore.prototype.getResourceBundle = function getResourceBundle(lng, ns) {
    ...
    if (this.options.compatibilityAPI === 'v1') return _extends$6({}, this.getResource(lng, ns));
...
var Translator = function (_EventEmitter) {
      ...
      if (keySeparator) {
        ...
        for (var m in res) {
          if (Object.prototype.hasOwnProperty.call(res, m)) {
            ...
            copy$$1[m] = this.translate(deepKey, _extends$7({}, options, { joinArrays: false, ns: namespaces }));
  ...
  Translator.prototype.extendTranslation = function extendTranslation(res, key, options, resolved) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse) {
      ...
      // i18next.parsing
      if (options.interpolation) this.interpolator.init(_extends$7({}, options, { interpolation: _extends$7({}, this.options.interpolation, options.interpolation) }));

      // interpolate
      var data = options.replace && typeof options.replace !== 'string' ? options.replace : options;
      if (this.options.interpolation.defaultVariables) data = _extends$7({}, this.options.interpolation.defaultVariables, data);
...
var Interpolator = function () {
  ...
  Interpolator.prototype.nest = function nest(str, fc) {
    ...
    var clonedOptions = _extends$8({}, options);
    ...
    function handleHasOptions(key, inheritedOptions) {
      ...
      try {
        ...
        if (inheritedOptions) clonedOptions = _extends$8({}, inheritedOptions, clonedOptions);
      } catch (e) {
...
var Connector = function (_EventEmitter) {
  ...
  Connector.prototype.saveMissing = function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
    ...
    if (this.backend && this.backend.create) {
      this.backend.create(languages, namespace, key, fallbackValue, null /* unused callback */, _extends$9({}, options, { isUpdate: isUpdate }));
    }
...
var I18n$1 = function (_EventEmitter) {
  ...
  I18n.prototype.init = function init() {
    ...
    this.options = _extends$10({}, get(), this.options, transformOptions(options));
  ...
  I18n.prototype.cloneInstance = function cloneInstance() {
    ...
    var mergedOptions = _extends$10({}, this.options, options, { isClone: true });
...
reactDom.hydrate(react.createElement(HomeContainer, null), document.getElementById('home'));
