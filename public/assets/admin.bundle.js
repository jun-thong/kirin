...
var tinyUuid = function(a,b){for(b=a='';a++<36;b+=a*51&52?(a^15?8^Math.random()*(a^20?16:4):4).toString(16):'-');return b};
...
function subscribe() {
  ...
  return function (Wrapped) {
    return function SubscribeWrap(props) {
      ...
      return contextRefs.reduceRight(function (inner, ctx) {
        return function () {
          ...
          return react.createElement(ctx.Consumer, null, function (value) {
        ...
        return react.createElement(Wrapped, _extends({}, props, context));
      })();
    };
  };
}
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _props = this.props,
        ...
        rest = _objectWithoutProperties(_props, ["to", "select", "children"]);

    return react.createElement(subscribe(to, select)(function (props) {
...
function createStore(data, id) {
  ...
  var initialState = data.initialState,
    ...
    setState: function setState(props) {
      ...
      props = _objectWithoutProperties(data, ["initialState", "actions"]);
...
function (_React$PureComponent2) {
  ...
  function Provider(props) {
    ...
    var store = props.store,
        ...
        rest = _objectWithoutProperties(props, ["store", "children", "id", "actions", "initialState"]);

    _this.store = store || createStore(_objectSpread({}, rest, {
      initialState: initialState,
      actions: actions
    }), id); // When no store is given, create context by id or refer to the default context

    if (!store) _this.store.context = id ? createNamedContext(id) : ProviderContext; // Bind actions to setState

    if (_this.store.actions) {
      var _actions = _this.store.actions;
      _this.store.actions = Object.keys(_actions).reduce(function (acc, name) {
        var _objectSpread2;

        return _objectSpread({}, acc, (_objectSpread2 = {}, _objectSpread2[name] = function () {
          var result = _actions[name].apply(_actions, arguments);

          if (typeof result === 'function') result = result(_this.state);
    ...
    _this.state = _this.store.initialState;
    return _this;
  }
  ...
  _proto2.render = function render() {
    ...
    var value = _objectSpread({}, props, this.state, actions ? {
      actions: actions
    } : {});

    return react.createElement(this.store.context.Provider, {
      value: value,
...
var Interpolate = function (_Component) {
  _inherits$2(Interpolate, _Component);

  function Interpolate(props, context) {
    _classCallCheck$2(this, Interpolate);

    var _this = _possibleConstructorReturn$2(this, (Interpolate.__proto__ || Object.getPrototypeOf(Interpolate)).call(this, props, context));
...
function nodesToString(mem, children, index) {
  ...
  children.forEach(function (child, i) {
    ...
    } else if ((typeof child === 'undefined' ? 'undefined' : _typeof$1(child)) === 'object') {
    ...
    return astNodes.reduce(function (mem, node, i) {
      if (node.type === 'tag') {
        ...
        if (typeof child === 'string') {
          ...
          mem.push(react.cloneElement(child, _extends$5({}, child.props, { key: i }), inner));
        } else if ((typeof child === 'undefined' ? 'undefined' : _typeof$1(child)) === 'object' && !isElement) {
...
var Trans = function (_React$Component) {
  _inherits$3(Trans, _React$Component);

  function Trans() {
    _classCallCheck$3(this, Trans);

    return _possibleConstructorReturn$3(this, (Trans.__proto__ || Object.getPrototypeOf(Trans)).apply(this, arguments));
  }

  _createClass$3(Trans, [{
    key: 'render',
    value: function render() {
      ...
      var children = contextAndProps.children,
          ...
          additionalProps = _objectWithoutProperties$2(contextAndProps, ['children', 'count', 'parent', 'i18nKey', 'tOptions', 'ns', 'i18n', 't']);
      ...
      var translation = key ? t(key, _extends$5({}, tOptions, { interpolation: { prefix: '#$?', suffix: '?$#' }, defaultValue: defaultValue, count: count, ns: namespace })) : defaultValue;
...
var I18nextProvider = function (_Component) {
  _inherits$4(I18nextProvider, _Component);

  function I18nextProvider(props, context) {
    _classCallCheck$4(this, I18nextProvider);

    var _this = _possibleConstructorReturn$4(this, (I18nextProvider.__proto__ || Object.getPrototypeOf(I18nextProvider)).call(this, props, context));
  ...
  _createClass$4(I18nextProvider, [{
    key: 'getChildContext',
    value: function getChildContext() {
...
var Logger = function () {
  ...
  Logger.prototype.create = function create(moduleName) {
    return new Logger(this.logger, _extends$6({ prefix: this.prefix + ':' + moduleName + ':' }, this.options));
  };
...
var EventEmitter = function () {
  function EventEmitter() {
    _classCallCheck$6(this, EventEmitter);
...
var ResourceStore = function (_EventEmitter) {
  _inherits$5(ResourceStore, _EventEmitter);

  function ResourceStore(data) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { ns: ['translation'], defaultNS: 'translation' };

    _classCallCheck$7(this, ResourceStore);
  ...
  ResourceStore.prototype.addResourceBundle = function addResourceBundle(lng, ns, resources, deep, overwrite) {
    ...
    if (deep) {
      ...
      pack = _extends$7({}, pack, resources);
    }
  ...
  ResourceStore.prototype.getResourceBundle = function getResourceBundle(lng, ns) {
    ...
    if (this.options.compatibilityAPI === 'v1') return _extends$7({}, this.getResource(lng, ns));
...
var Translator = function (_EventEmitter) {
  _inherits$6(Translator, _EventEmitter);

  function Translator(services) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck$8(this, Translator);
  ...
  Translator.prototype.translate = function translate(keys, options) {
    ...
    if ((typeof options === 'undefined' ? 'undefined' : _typeof$3(options)) !== 'object' && this.options.overloadTranslationOptionHandler) {
      ...
      if (keySeparator) {
        ...
        for (var m in res) {
          if (Object.prototype.hasOwnProperty.call(res, m)) {
            ...
            copy$$1[m] = this.translate(deepKey, _extends$8({}, options, { joinArrays: false, ns: namespaces }));
  ...
  Translator.prototype.extendTranslation = function extendTranslation(res, key, options, resolved) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse) {
      ...
      // i18next.parsing
      if (options.interpolation) this.interpolator.init(_extends$8({}, options, { interpolation: _extends$8({}, this.options.interpolation, options.interpolation) }));

      // interpolate
      var data = options.replace && typeof options.replace !== 'string' ? options.replace : options;
      if (this.options.interpolation.defaultVariables) data = _extends$8({}, this.options.interpolation.defaultVariables, data);
...
var PluralResolver = function () {
  function PluralResolver(languageUtils) {
    ...
    _classCallCheck$10(this, PluralResolver);
...
var Interpolator = function () {
  function Interpolator() {
    ...
    _classCallCheck$11(this, Interpolator);
  ...
  Interpolator.prototype.nest = function nest(str, fc) {
    ...
    var clonedOptions = _extends$9({}, options);
    ...
    function handleHasOptions(key, inheritedOptions) {
      ...
      try {
        ...
        if (inheritedOptions) clonedOptions = _extends$9({}, inheritedOptions, clonedOptions);
      } catch (e) {
...
var Connector = function (_EventEmitter) {
  _inherits$7(Connector, _EventEmitter);

  function Connector(backend, store, services) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck$12(this, Connector);
  ...
  Connector.prototype.saveMissing = function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
    ...
    if (this.backend && this.backend.create) {
      this.backend.create(languages, namespace, key, fallbackValue, null /* unused callback */, _extends$10({}, options, { isUpdate: isUpdate }));
    }
...
var I18n$1 = function (_EventEmitter) {
  _inherits$8(I18n, _EventEmitter);

  function I18n() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var callback = arguments[1];

    _classCallCheck$13(this, I18n);
    ...
    if (callback && !_this.isInitialized && !options.isClone) {
      ...
      if (!_this.options.initImmediate) return _ret = _this.init(options, callback), _possibleConstructorReturn$8(_this, _ret);
      setTimeout(function () {
  ...
  I18n.prototype.init = function init() {
    ...
    this.options = _extends$11({}, get(), this.options, transformOptions(options));
  ...
  I18n.prototype.cloneInstance = function cloneInstance() {
    ...
    var mergedOptions = _extends$11({}, this.options, options, { isClone: true });
...
var loadNamespaces$1 = i18next.loadNamespaces.bind(i18next);
...
var Router = function (_React$Component) {
  _inherits$9(Router, _React$Component);

  function Router() {
    var _temp, _this, _ret;

    _classCallCheck$14(this, Router);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$9(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
  ...
  Router.prototype.getChildContext = function getChildContext() {
    return {
      router: _extends$12({}, this.context.router, {
...
var BrowserRouter = function (_React$Component) {
  _inherits$10(BrowserRouter, _React$Component);

  function BrowserRouter() {
    var _temp, _this, _ret;

    _classCallCheck$15(this, BrowserRouter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$10(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHistory(_this.props), _temp), _possibleConstructorReturn$10(_this, _ret);
  }
...
var HashRouter = function (_React$Component) {
  _inherits$11(HashRouter, _React$Component);

  function HashRouter() {
    var _temp, _this, _ret;

    _classCallCheck$16(this, HashRouter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$11(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHistory$1(_this.props), _temp), _possibleConstructorReturn$11(_this, _ret);
  }
...
var Link = function (_React$Component) {
  _inherits$12(Link, _React$Component);

  function Link() {
    var _temp, _this, _ret;

    _classCallCheck$17(this, Link);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$12(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (event) {
  ...
  Link.prototype.render = function render() {
    ...
    return react.createElement('a', _extends$13({}, props, { onClick: this.handleClick, href: href, ref: innerRef }));
  };
...
var MemoryRouter = function (_React$Component) {
  _inherits$13(MemoryRouter, _React$Component);

  function MemoryRouter() {
    var _temp, _this, _ret;

    _classCallCheck$18(this, MemoryRouter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$13(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHistory$2(_this.props), _temp), _possibleConstructorReturn$13(_this, _ret);
  }
...
var Route = function (_React$Component) {
  _inherits$14(Route, _React$Component);

  function Route() {
    var _temp, _this, _ret;

    _classCallCheck$19(this, Route);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$14(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
  ...
  Route.prototype.getChildContext = function getChildContext() {
    return {
      router: _extends$14({}, this.context.router, {
        route: {
...
var NavLink = function NavLink(_ref) {
  ...
  return react.createElement(Route, {
    ...
    children: function children(_ref2) {
      ...
      return react.createElement(Link, _extends$15({
        to: to,
        className: isActive ? [className, activeClassName].filter(function (i) {
          return i;
        }).join(' ') : className,
        style: isActive ? _extends$15({}, style, activeStyle) : style,
...
var Prompt = function (_React$Component) {
  _inherits$15(Prompt, _React$Component);

  function Prompt() {
    _classCallCheck$20(this, Prompt);

    return _possibleConstructorReturn$15(this, _React$Component.apply(this, arguments));
  }
...
var Redirect = function (_React$Component) {
  _inherits$16(Redirect, _React$Component);

  function Redirect() {
    _classCallCheck$21(this, Redirect);

    return _possibleConstructorReturn$16(this, _React$Component.apply(this, arguments));
  }
...
var StaticRouter = function (_React$Component) {
  _inherits$17(StaticRouter, _React$Component);

  function StaticRouter() {
    var _temp, _this, _ret;

    _classCallCheck$22(this, StaticRouter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$17(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.createHref = function (path) {
  ...
  StaticRouter.prototype.render = function render() {
    ...
    return react.createElement(Router, _extends$20({}, props, { history: history }));
  };
...
var Switch = function (_React$Component) {
  _inherits$18(Switch, _React$Component);

  function Switch() {
    _classCallCheck$23(this, Switch);

    return _possibleConstructorReturn$18(this, _React$Component.apply(this, arguments));
  }
...
let DefaultLayout = (_temp = _class = class DefaultLayout extends react.Component {
...
let Dashboard = (_temp$1 = _class$1 = class Dashboard extends react.Component {
 ...
 */
let AdminContainer = class AdminContainer extends react.Component {
    render() {
        return react.createElement(
            Provider,
...
reactDom.hydrate(react.createElement(AdminContainer, null), document.getElementById('app'));
