...
function setDefaults(options) {
  defaultOptions = _extends$11({}, defaultOptions, options);
}
...
var I18n = function (_Component) {
  _inherits$10(I18n, _Component);

  function I18n(props, context) {
    _classCallCheck$10(this, I18n);

    var _this = _possibleConstructorReturn$10(this, (I18n.__proto__ || Object.getPrototypeOf(I18n)).call(this, props, context));
    ...
    _this.options = _extends$12({}, getDefaults(), i18nOptions, props);
...
function translate(namespaceArg) {
  ...
  return function Wrapper(WrappedComponent) {
    var Translate = function (_Component) {
      _inherits$11(Translate, _Component);

      function Translate(props, context) {
        _classCallCheck$11(this, Translate);

        var _this = _possibleConstructorReturn$11(this, (Translate.__proto__ || Object.getPrototypeOf(Translate)).call(this, props, context));
        ...
        var i18nOptions = _this.i18n && _this.i18n.options && _this.i18n.options.react || {};
        _this.options = _extends$13({}, getDefaults(), i18nOptions, options);

        _this.getWrappedInstance = _this.getWrappedInstance.bind(_this);
        return _this;
      }

      _createClass$1(Translate, [{
        ...
        value: function render() {
          ...
          return react.createElement(I18n, _extends$13({ ns: this.namespaces }, this.options, this.props, { i18n: this.i18n }), function (t, _ref) {
            var ready = _ref.ready,
                context = _objectWithoutProperties$5(_ref, ['ready']);

            return react.createElement(WrappedComponent, _extends$13({
              tReady: ready
...
var Interpolate = function (_Component) {
  _inherits$12(Interpolate, _Component);

  function Interpolate(props, context) {
    _classCallCheck$12(this, Interpolate);

    var _this = _possibleConstructorReturn$12(this, (Interpolate.__proto__ || Object.getPrototypeOf(Interpolate)).call(this, props, context));
  ...
  _createClass$2(Interpolate, [{
    ...
    value: function render() {
      ...
      var tOpts = _extends$14({}, this.props.options, { interpolation: { prefix: '#$?', suffix: '?$#' } });
...
function nodesToString(mem, children, index) {
  ...
  children.forEach(function (child, i) {
    ...
    } else if ((typeof child === 'undefined' ? 'undefined' : _typeof$5(child)) === 'object') {
      var clone = _extends$15({}, child);
    ...
    return astNodes.reduce(function (mem, node, i) {
      if (node.type === 'tag') {
        ...
        if (typeof child === 'string') {
          ...
          mem.push(react.cloneElement(child, _extends$15({}, child.props, { key: i }), inner));
        } else if ((typeof child === 'undefined' ? 'undefined' : _typeof$5(child)) === 'object' && !isElement) {
...
var Trans = function (_React$Component) {
  _inherits$13(Trans, _React$Component);

  function Trans() {
    _classCallCheck$13(this, Trans);

    return _possibleConstructorReturn$13(this, (Trans.__proto__ || Object.getPrototypeOf(Trans)).apply(this, arguments));
  }

  _createClass$3(Trans, [{
    key: 'render',
    value: function render() {
      var contextAndProps = _extends$15({ i18n: this.context.i18n, t: this.context.t }, this.props);
      ...
      var children = contextAndProps.children,
          ...
          additionalProps = _objectWithoutProperties$6(contextAndProps, ['children', 'count', 'parent', 'i18nKey', 'tOptions', 'ns', 'i18n', 't']);
      ...
      var translation = key ? t(key, _extends$15({}, tOptions, { interpolation: { prefix: '#$?', suffix: '?$#' }, defaultValue: defaultValue, count: count, ns: namespace })) : defaultValue;
...
var I18nextProvider = function (_Component) {
  _inherits$14(I18nextProvider, _Component);

  function I18nextProvider(props, context) {
    _classCallCheck$14(this, I18nextProvider);

    var _this = _possibleConstructorReturn$14(this, (I18nextProvider.__proto__ || Object.getPrototypeOf(I18nextProvider)).call(this, props, context));
...
var Logger = function () {
  function Logger(concreteLogger) {
    ...
    _classCallCheck$15(this, Logger);
  ...
  Logger.prototype.create = function create(moduleName) {
    return new Logger(this.logger, _extends$16({ prefix: this.prefix + ':' + moduleName + ':' }, this.options));
  };
...
var EventEmitter = function () {
  function EventEmitter() {
    _classCallCheck$16(this, EventEmitter);
...
var ResourceStore = function (_EventEmitter) {
  _inherits$15(ResourceStore, _EventEmitter);

  function ResourceStore(data) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { ns: ['translation'], defaultNS: 'translation' };

    _classCallCheck$17(this, ResourceStore);

    var _this = _possibleConstructorReturn$15(this, _EventEmitter.call(this));
  ...
  ResourceStore.prototype.addResourceBundle = function addResourceBundle(lng, ns, resources, deep, overwrite) {
    ...
    if (deep) {
      ...
      pack = _extends$17({}, pack, resources);
    }
  ...
  ResourceStore.prototype.getResourceBundle = function getResourceBundle(lng, ns) {
    ...
    if (this.options.compatibilityAPI === 'v1') return _extends$17({}, this.getResource(lng, ns));
...
var Translator = function (_EventEmitter) {
  _inherits$16(Translator, _EventEmitter);

  function Translator(services) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck$18(this, Translator);

    var _this = _possibleConstructorReturn$16(this, _EventEmitter.call(this));
  ...
  Translator.prototype.translate = function translate(keys, options) {
    ...
    if ((typeof options === 'undefined' ? 'undefined' : _typeof$7(options)) !== 'object' && this.options.overloadTranslationOptionHandler) {
      ...
      if (keySeparator) {
        ...
        for (var m in res) {
          if (Object.prototype.hasOwnProperty.call(res, m)) {
            ...
            copy$$1[m] = this.translate(deepKey, _extends$18({}, options, { joinArrays: false, ns: namespaces }));
  ...
  Translator.prototype.extendTranslation = function extendTranslation(res, key, options, resolved) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse) {
      ...
      // i18next.parsing
      if (options.interpolation) this.interpolator.init(_extends$18({}, options, { interpolation: _extends$18({}, this.options.interpolation, options.interpolation) }));

      // interpolate
      var data = options.replace && typeof options.replace !== 'string' ? options.replace : options;
      if (this.options.interpolation.defaultVariables) data = _extends$18({}, this.options.interpolation.defaultVariables, data);
...
var LanguageUtil = function () {
  function LanguageUtil(options) {
    _classCallCheck$19(this, LanguageUtil);
...
var PluralResolver = function () {
  function PluralResolver(languageUtils) {
    ...
    _classCallCheck$20(this, PluralResolver);
...
var Interpolator = function () {
  function Interpolator() {
    ...
    _classCallCheck$21(this, Interpolator);
  ...
  Interpolator.prototype.nest = function nest(str, fc) {
    ...
    var clonedOptions = _extends$19({}, options);
    ...
    function handleHasOptions(key, inheritedOptions) {
      ...
      try {
        ...
        if (inheritedOptions) clonedOptions = _extends$19({}, inheritedOptions, clonedOptions);
      } catch (e) {
...
var Connector = function (_EventEmitter) {
  _inherits$17(Connector, _EventEmitter);

  function Connector(backend, store, services) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck$22(this, Connector);

    var _this = _possibleConstructorReturn$17(this, _EventEmitter.call(this));
  ...
  Connector.prototype.saveMissing = function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
    ...
    if (this.backend && this.backend.create) {
      this.backend.create(languages, namespace, key, fallbackValue, null /* unused callback */, _extends$20({}, options, { isUpdate: isUpdate }));
    }
...
var I18n$1 = function (_EventEmitter) {
  _inherits$18(I18n, _EventEmitter);

  function I18n() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var callback = arguments[1];

    _classCallCheck$23(this, I18n);

    var _this = _possibleConstructorReturn$18(this, _EventEmitter.call(this));
    ...
    if (callback && !_this.isInitialized && !options.isClone) {
      ...
      if (!_this.options.initImmediate) return _ret = _this.init(options, callback), _possibleConstructorReturn$18(_this, _ret);
      setTimeout(function () {
  ...
  I18n.prototype.init = function init() {
    ...
    this.options = _extends$21({}, get(), this.options, transformOptions(options));
  ...
  I18n.prototype.getFixedT = function getFixedT(lng, ns) {
    ...
    var fixedT = function fixedT(key, opts) {
      ...
      var options = _extends$21({}, opts);
      if ((typeof opts === 'undefined' ? 'undefined' : _typeof$8(opts)) !== 'object') {
  ...
  I18n.prototype.cloneInstance = function cloneInstance() {
    ...
    var mergedOptions = _extends$21({}, this.options, options, { isClone: true });
...
let Nav = (_dec = translate(['commons', 'nav']), _dec(_class = (_temp = _class2 = class Nav extends react.Component {
            ...
            react.createElement(
                ...
                react.createElement(
                    ...
                    react.createElement(
                        NavLink,
                        { to: '/', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-home icon-large' })
                    )
                ),
                react.createElement(
                    'li',
                    ...
                    react.createElement(
                        NavLink,
                        { to: '/profile', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-user icon-large' })
                    )
                ),
                react.createElement(
                    'li',
                    ...
                    react.createElement(
                        'a',
                        { href: '/channels', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-channel icon-large' })
                    )
                ),
                react.createElement(
                    'li',
                    ...
                    react.createElement(
                        'a',
                        { href: '/channels', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-notification icon-large' })
                    )
                ),
                react.createElement(
                    'li',
                    ...
                    react.createElement(
                        'a',
                        { href: '/chat', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-chat icon-large' })
                    )
                ),
                react.createElement(
                    'li',
                    ...
                    react.createElement(
                        'a',
                        { href: '/settings', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-cog icon-large' })
                    )
                ),
                react.createElement(
                    'li',
                    ...
                    react.createElement(
                        'a',
                        { href: '/logout', className: 'nav-el' },
                        react.createElement('span', { className: 'icon-logout icon-large' })
                    )
                )
            )
        );
...
let DefaultLayout = (_temp$1 = _class$1 = class DefaultLayout extends react.Component {
...
let Dashboard = (_dec$1 = translate(['commons', 'dashboard']), _dec2 = subscribe(store => ({
    feed: store.feed
})), _dec$1(_class$2 = _dec2(_class$2 = (_temp$2 = _class2$1 = class Dashboard extends react.Component {
...
let Dashboard$1 = (_dec$2 = translate(['commons', 'profile']), _dec2$1 = subscribe(store => ({
    feed: store.feed
})), _dec$2(_class$3 = _dec2$1(_class$3 = (_temp$3 = _class2$2 = class Dashboard extends react.Component {
...
let App = class App extends react.Component {
    render() {
        return react.createElement(
            ...
            react.createElement(Route, { path: '/profile', component: Dashboard$1 }),
            react.createElement(Route, { path: '/profile/:slug', component: Dashboard$1 })
        );
    }
};
 ...
 */
let AppContainer = class AppContainer extends react.Component {
    render() {
        return react.createElement(
            Provider,
...
reactDom.hydrate(react.createElement(AppContainer, null), document.getElementById('app'));
//# sourceMappingURL=kirin.bundle.js.map
